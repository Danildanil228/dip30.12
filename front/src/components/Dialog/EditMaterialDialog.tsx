...
export default function EditMaterialDialog({ materialId, onMaterialUpdated, triggerButton, children }: EditMaterialDialogProps) {
        ...
        <AlertDialog open={open} onOpenChange={handleOpenChange}>
            ...
            <AlertDialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>{material ? `${material.name}` : "Загрузка данных..."}</AlertDialogDescription>
                </AlertDialogHeader>
                        ...
                        <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="edit-material-code" placeholder="Например: CEM-001" value={code} onChange={(e) => setCode(e.target.value)} disabled={loading} required />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="edit-material-quantity" value={material?.quantity || 0} disabled className="bg-gray-50" />
                                    <p className="text-xs text-gray-500">
                                        Количество изменяется только через операции{" "}
                                        <Link to="/requests" className="underline dark:text-gray-100 text-black">
                                            прихода/расхода
                                        </Link>
                                    </p>
                                </div>
