    ...
    return (
        <div className="relative" ref={searchRef}>
            <div className="relative">
                ...
                <Input placeholder="Поиск по имени, фамилии или логину..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} onFocus={() => searchTerm.length >= 2 && setShowResults(true)} className="pl-10" />
            </div>
            ...
            {showResults && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-background rounded-lg shadow-lg z-50 max-h-64 overflow-y-auto">
                    ...
                    {users.map((user) => (
                        <div key={user.id} className="flex items-center justify-between p-3 hover:bg-muted cursor-pointer " onClick={() => handleSelectUser(user)}>
                            <div>
