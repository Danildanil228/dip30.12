...
const checkUserInDB = async (req, res, next) => {
    try {
        ...
        const result = await pool.query("SELECT id, username, role, name, secondname, email, phone, birthday, avatar FROM users WHERE id = $1 AND deleted_at IS NULL", [req.userFromToken.id]);
